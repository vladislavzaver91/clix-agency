      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-4xl font-bold text-gray-900">Completed Orders</h1>
          </div>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-gray-600 mb-1">Amount: {formatAmount(order.amount)}</p>
                    {order.description && (
                      <p className="text-gray-600 mb-1">Description: {order.description}</p>
                    )}
