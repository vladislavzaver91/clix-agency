...
const faqItems = [
	{
		question: 'How does CLIX ensure compliance with healthcare regulations?',
		answer:
		...
		<section className='relative py-14 bg-background'>
			...
			<div className='container max-w-3xl mx-auto px-4'>
				<div className='text-center mb-10 overflow-hidden'>
					...
					>
						Get answers to the most common questions about building impactful
						healthcare websites with CLIX.
					</motion.p>
				</div>
