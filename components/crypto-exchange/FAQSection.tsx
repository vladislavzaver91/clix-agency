...
const faqItems = [
	...
	{
		question: 'How do you ensure the security of a cryptocurrency exchange?',
		answer:
		...
		<section className='relative py-14 bg-background'>
			...
			<div className='container max-w-3xl mx-auto px-4'>
				<div className='text-center mb-10 overflow-hidden'>
					...
					>
						Everything you need to know about launching a secure and scalable
						cryptocurrency exchange with CLIX.
					</motion.p>
				</div>
