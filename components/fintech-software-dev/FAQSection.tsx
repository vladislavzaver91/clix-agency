...
const faqItems = [
	{
		question: 'How does CLIX ensure the security of my fintech application?',
		answer:
	...
	{
		question: 'What industries do you cater to with your fintech solutions?',
		answer:
		...
		<section className='relative py-14 bg-background'>
			...
			<div className='container max-w-3xl mx-auto px-4'>
				<div className='text-center mb-10 overflow-hidden'>
					...
					>
						Find answers to the most common questions about creating secure,
						innovative, and efficient fintech solutions.
					</motion.p>
				</div>
